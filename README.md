...
Source URL: https://github.com/wowchemy/starter-hugo-academic

- https://shiruipan.github.io/
- https://iphysresearch.github.io/blog/post/writting-markdown/
- https://matteocourthoud.github.io/
- https://github.com/salecharohit/rohitsalecha.com

### 其他

- [animate-hugo-academic](https://www.connorrothschild.com/post/animate-hugo-academic)

## 国内使用

`hugo server -D` 之前，需要修改下 proxy
